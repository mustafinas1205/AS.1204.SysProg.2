...
{//100000000000000000000000000000
	...
	if ((Info->robots[id]->name=="robotbase.10")||(Info->robots[id]->name=="robotbase.10.1"))
		for (i=0;i<Nrob;i++)		
			if ((Info->robots[i]->name=="robotbase.01")||(Info->robots[i]->name=="robotbase.01.1"))
			{idarh=i;hh=1;}

	if ((Info->robots[id]->name=="robotbase.10.2"))
		for (i=0;i<Nrob;i++)
			if (Info->robots[i]->name=="robotbase.01.2")
				{idarh=i;hh=1;}

	if ((Info->robots[id]->name=="robotbase.10.3"))
		for (i=0;i<Nrob;i++)
			if (Info->robots[i]->name=="robotbase.01.3")
				{idarh=i;hh=1;}

	if ((Info->robots[id]->name=="robotbase.10.4"))
		for (i=0;i<Nrob;i++)
			if (Info->robots[i]->name=="robotbase.01.4")
				{idarh=i;hh=1;}

	if ((Info->robots[id]->name=="robotbase.10.5"))
		for (i=0;i<Nrob;i++)
			if (Info->robots[i]->name=="robotbase.01.5")
				{idarh=i;hh=1;}
